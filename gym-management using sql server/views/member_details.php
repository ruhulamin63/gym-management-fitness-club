		...
		<form method="post" action="member_details.php">
			<fieldset>
				<div class="input-group">
				  <input type="search" name="mem_id_search" class="form-control rounded" placeholder="Search by Member Id" aria-label="Search"
...
<!-- ========================================================= -->
	...
	<?php 
		...
		$statement=showMemberDetails();
  		...
  		while($row=sqlsrv_fetch_array($statement,OCI_ASSOC+OCI_RETURN_NULLS)){
...
<!-- ========================================================= -->
	<?php 
		...
		if(isset($_POST['search_btn'])){
			...
			$statement=sqlsrv_parse($conn,$sql);
