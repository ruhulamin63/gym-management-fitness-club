                        ...
                        <div class="sidebar-nav navbar-collapse">
                            <ul class="nav" id="side-menu">
                                ...
                                <li>
                                    ...
                                    <ul class="nav nav-second-level">
                                        <li>
                                            <a href="#"><i class="fa fa-plus fa-fw"></i>Add Members</a>
                                        </li>
                                          <li>
                                            <a href="#"><i class="fa fa-plus fa-fw"></i>Add Trainers</a>
                                        </li>
                                          <li>
                                            <a href="#"><i class="fa fa-plus fa-fw"></i>Add Money</a>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li>
                                    ...
                                    <ul class="nav nav-second-level">
                                        <li>
                                            <a href="#"><i class="fa fa-pencil" aria-hidden="true"></i>Edit Members</a>
                                        </li>
                                          <li>
